 ...
 * emulated with a file (PC memory).
...
interface PoPCMemHALI {
   ...
   /**
   * Reads one byte of data from the selected address of the PC memory file.
   ...
   **/
   ...
   /**
   * Reads two bytes of data from the selected address of the PC memory file.
   * @param addr memory address from where to start getting data
   ...
   **/
   ...
   /**
   * Reads four bytes of data from the selected address of the PC memory file.
   * @param addr memory address from where to start getting data
   * @return Fetched data bytes.  
   *
   **/
   ...
   /**
   * Reads block of data from the selected address of the PC memory file.
   * @param addr memory address from where to start getting data
   ...
   **/
   ...
   /**
   * Writes one byte of data at the selected address of the PC memory file.
   ...
   **/
   ...
   /**
   * Writes two bytes of data at the selected address of the PC memory file.
   * @param addr memory address where to start putting data
   ...
   **/
   ...
   /**
   * Writes four bytes of data at the selected address of the PC memory file.
   * @param addr memory address where to start putting data
   ...
   **/
   ...
   /**
   * Writes a block of data at the selected address of the PC memory file.
   * @param addr memory address where to start putting data
   ...
   * data writes to the PC memory file are committed. 
   **/	
	command void flush();
